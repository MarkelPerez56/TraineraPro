...
import svgPaths from "./svg-t0m2paatnb";
type Wrapper3Props = {
...
export default function NuevoTestTiempo() {
  return (
    <div className="bg-white relative size-full" data-name="Nuevo Test Tiempo">
                ...
                <div className="col-1 content-stretch flex gap-[6px] items-center justify-self-start relative row-1 self-stretch shrink-0 w-[191px]" data-name="Container">
                  <div className="relative shrink-0 size-[14px]" data-name="Icon">
                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
                      <g clipPath="url(#clip0_50_1771)" id="Icon">
                  ...
                  <div className="bg-[#f3f3f5] flex-[1_0_0] h-[32px] min-h-px min-w-px relative rounded-[8px]" data-name="at">
                    <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[12px] py-[4px] relative size-full">
                        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#717182] text-[14px] tracking-[-0.1504px]">Min *</p>
                      </div>
                    </div>
                    <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[8px]" />
                  </div>
      ...
      <Text2 text="Tiempo" additionalClassNames="left-[587px] top-[305px]" />
    </div>
  );
}