...
import svgPaths from "./svg-2b5h9txnri";
type Wrapper3Props = {
...
function Icon13Vector({ children }: React.PropsWithChildren<{}>) {
  return (
...
export default function NuevoTestMetros() {
  return (
    <div className="bg-white relative size-full" data-name="Nuevo Test Metros">
      ...
      <div className="absolute bg-white border border-[rgba(0,0,0,0.1)] border-solid h-[411px] left-[333px] overflow-clip rounded-[10px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[133px] w-[512px]" data-name="Frame">
        ...
        <div className="absolute content-stretch flex flex-col gap-[15px] h-[261px] items-start left-[24px] top-[65px] w-[462px]" data-name="d3">
          ...
          <div className="content-stretch flex flex-col h-[115px] items-start relative shrink-0 w-full" data-name="Container">
            ...
            <div className="bg-[rgba(236,236,240,0.3)] content-stretch flex flex-col h-[66px] items-start pb-px pl-[13px] pt-[25px] relative rounded-[10px] shrink-0 w-[225px]" data-name="Container">
              ...
              <div className="gap-x-[8px] gap-y-[8px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[repeat(1,minmax(0,1fr))] h-[32px] relative shrink-0 w-full" data-name="Container">
                <div className="col-1 content-stretch flex gap-[6px] items-center justify-self-start relative row-1 self-stretch shrink-0 w-[191px]" data-name="Container">
                  <div className="relative shrink-0 size-[14px]" data-name="Icon">
                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
                      <g clipPath="url(#clip0_50_1786)" id="Icon">
                        <path d={svgPaths.p3f21a0f0} id="Vector" stroke="var(--stroke-0, #00C950)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
                        <path d="M8.45833 7.29167L9.625 6.125" id="Vector_2" stroke="var(--stroke-0, #00C950)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
                        <path d="M6.70833 5.54167L7.875 4.375" id="Vector_3" stroke="var(--stroke-0, #00C950)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
                        <path d="M4.95833 3.79167L6.125 2.625" id="Vector_4" stroke="var(--stroke-0, #00C950)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
                        <path d={svgPaths.p2b007c80} id="Vector_5" stroke="var(--stroke-0, #00C950)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
                      </g>
                      <defs>
                        <clipPath id="clip0_50_1786">
                          <rect fill="white" height="14" width="14" />
                        </clipPath>
                      </defs>
                    </svg>
                  </div>
                  <div className="bg-[#f3f3f5] flex-[1_0_0] h-[32px] min-h-px min-w-px relative rounded-[8px]" data-name="at">
                    <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[12px] py-[4px] relative size-full">
                        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#717182] text-[14px] tracking-[-0.1504px]">Metros *</p>
                      </div>
                    </div>
                    <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[8px]" />
                  </div>
      ...
      <Text2 text="Metros" additionalClassNames="left-[587px] top-[305px]" />
    </div>
  );
}